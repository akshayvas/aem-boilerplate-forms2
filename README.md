...
## Environments
- Preview: https://main--aem-boilerplate-forms2--akshayvas.hlx.page/
- Live: https://main--aem-boilerplate-forms2--akshayvas.hlx.live/
...
1. Open the `aem-boilerplate-forms2` directory in your favorite IDE and start coding :)
